...
Try the live version: [https://utkrsh1011.pythonanywhere.com/](https://utkrsh1011.pythonanywhere.com/)
...
- **Download & Share**: Download images or open them in new tabs
...
4. Customize options as needed (full page, format, viewport size)
